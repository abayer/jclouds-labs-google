...
public class ParseFirewallTest extends BaseGoogleComputeEngineParseTest<Firewall> {
   ...
   public Firewall expected() {
      return Firewall.builder()
              ...
              .selfLink(URI.create("https://www.googleapis.com/compute/v1beta15/projects/myproject/firewalls/jclouds-test"))
              .name("jclouds-test")
              .description("Internal traffic from default allowed")
              .network(URI.create("https://www.googleapis.com/compute/v1beta15/projects/myproject/networks/jclouds-test"))
