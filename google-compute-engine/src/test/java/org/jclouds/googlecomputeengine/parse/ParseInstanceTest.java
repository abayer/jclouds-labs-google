   ...
   public Instance expected() {
      return Instance.builder()
              ...
              .selfLink(URI.create("https://www.googleapis" +
                      ".com/compute/v1beta15/projects/myproject/instances/test-0"))
              .description("desc")
              .name("test-0")
              .image(URI.create("https://www.googleapis" +
                      ".com/compute/v1beta15/projects/google/global/images/gcel-12-04-v20121106"))
              .machineType(URI.create("https://www.googleapis.com/compute/v1beta15/projects/myproject/machineTypes/n1" +
                      "-standard-1"))
              ...
              .addDisk(
                      Instance.PersistentAttachedDisk.builder()
                              ...
                              .source(URI.create("https://www.googleapis" +
                                      ".com/compute/v1beta15/projects/myproject/disks/test"))
                              .build()
              )
              .addTag("aTag")
