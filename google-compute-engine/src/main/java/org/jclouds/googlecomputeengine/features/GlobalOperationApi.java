...
public interface GlobalOperationApi {
   ...
   @ResponseParser(ParseGlobalOperations.class)
   @Fallback(EmptyIterableWithMarkerOnNotFoundOr404.class)
   ListPage<Operation> aggregatedListAtMarker(@QueryParam("pageToken") @Nullable String marker);

   /**
    * TODO live and expect tests for aggregatedList
    * Retrieves the aggregatedListFirstPage of operation resources contained within the specified project.
    * By default the aggregatedListFirstPage as a maximum size of 100, if no options are provided or ListOptions#getMaxResults()
    * has not been set.
    *
    * @param marker      marks the beginning of the next list page
    * @param listOptions listing options
   ...
   /**
    * @see org.jclouds.googlecomputeengine.features.GlobalOperationApi#aggregatedList(org.jclouds.googlecomputeengine.options.ListOptions)
    */
   @Named("GlobalOperations:aggregatedList")
   @GET
   @Path("/aggregated/operations")
   ...
   @Transform(ParseGlobalOperations.ToPagedIterable.class)
   @Fallback(EmptyPagedIterableOnNotFoundOr404.class)
   PagedIterable<Operation> aggregatedList();

   /**
    * A paged version of GlobalOperationApi#aggregatedListFirstPage()
    *
    * @return a Paged, Fluent Iterable that is able to fetch additional pages when required
    * @see org.jclouds.collect.PagedIterable
    * @see org.jclouds.googlecomputeengine.features.GlobalOperationApi#aggregatedListAtMarker(String, org.jclouds.googlecomputeengine.options.ListOptions)
   ...
   @Transform(ParseGlobalOperations.ToPagedIterable.class)
   @Fallback(EmptyPagedIterableOnNotFoundOr404.class)
   PagedIterable<Operation> aggregatedList(ListOptions listOptions);
